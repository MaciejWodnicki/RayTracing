...
public:
	...
	Ray reflect(glm::vec3 normal, glm::vec3 hitPoint, Material material)
	{
		...
		glm::vec3 direction = glm::reflect(_direction, normal) + glm::normalize(glm::linearRand(glm::vec3(-0.5f, -0.5f, 0.5f),glm::vec3(0.5f, 0.5f, 0.5f))+normal) * material._roughness;
